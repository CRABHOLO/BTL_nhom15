...
<div>
      <hr />
        <div class="header-line-Footer"> <img src="images/icon/cauvang.png" alt="logo" name="logo" />
          <ul>
        ...
        <div class="footer-container" style="background:#f9c">
          ...
          <ul class="footer-table-1">
            ...
            <li><a href="#" class="format-url"> Tin Tức</a></li>
          </ul>
          <ul class="footer-table-1" >
            <h3> HƯỚNG DẪN MUA HÀNG </h3>
            <li><a href="#" class="format-url"> Hướng dẫn mua hàng</a></li>
       ...
       <div style="clear:both"></div>
       <div align="center">&copy;2022 - Thiết kế bởi nhóm 15</div>